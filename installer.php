...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220919_cuffing_d02ee4ddf4b0037a7890_20220919100019_archive.zip';
        const ARCHIVE_SIZE       = '65232309';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd02ee4d-19100019';
        const SECONDARY_PACKAGE_HASH = '642c78d-19100019';
        const VERSION            = '1.5.0';
